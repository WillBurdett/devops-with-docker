...
```console
$ docker run -d --rm -it --name logs devopsdockeruh/simple-web-service:ubuntu
...
```console
$ docker run -d --rm -it --name exercise ubuntu sh -c 'echo "Input website:"; read website; echo "Searching.."; sleep 1; curl http://$website;'
